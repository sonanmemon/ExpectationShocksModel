...
%\Taccount{Owner's Capital}{Debits&Credits\\Decrease&Increase\\&Normal Balance}
	...
	\begin{figure}[H]
	\includegraphics[width=0.5\linewidth]{inflation_expectationshock4periodphi0.95.pdf}
	\hfill
	\includegraphics[width=0.5\linewidth]{output_expectationshock4periodphi0.95.pdf}
	\hfill
	\begin{Center}
		\includegraphics[width=0.5\linewidth]{interestrates_expectationshock4periodphi0.95.pdf}
	\end{Center}
	\caption{Impulse Responses For 4 Period Shock and $\phi = 0.95$}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.5\linewidth]{inflation_expectationshock4periodphi0.05.pdf}
	\hfill
	\includegraphics[width=0.5\linewidth]{output_expectationshock4periodphi0.05.pdf}
	\hfill
	\begin{Center}
		\includegraphics[width=0.5\linewidth]{interestrates_expectationshock4periodphi0.05.pdf}
	\end{Center}
	\caption{Impulse Responses For 4 Period Shock and $\phi = 0.05$}
\end{figure}

\begin{figure}[H]
	\includegraphics[width=0.5\linewidth]{inflation_expectationshock4periodalpha0.05.pdf}
	\hfill
	\includegraphics[width=0.5\linewidth]{output_expectationshock4periodalpha0.05.pdf}
	\hfill
	\begin{Center}
		\includegraphics[width=0.5\linewidth]{interestrates_expectationshock4periodalpha0.05.pdf}
	\end{Center}
...
\begin{figure}[H]
	\includegraphics[width=0.5\linewidth]{inflation_expectationshock4periodalpha4.pdf}
	\hfill
	\includegraphics[width=0.5\linewidth]{output_expectationshock4periodalpha4.pdf}
	\hfill
	\begin{Center}
		\includegraphics[width=0.5\linewidth]{interestrates_expectationshock4periodalpha4.pdf}
	\end{Center}
