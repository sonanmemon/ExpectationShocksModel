...
inf = scatter(xaxis, inflation, label="Inflation's Response to Expectation Shock", xtick = false)
plot!(xticks = period, xtickfontsize = 5)
xlabel!("1st Period Shock and After (2 to 50)")
ylabel!("Inflation (%)")
savefig("inflation_expectationshock.pdf")

inf = scatter(xaxis, inflation_model2, label="Inflation's Response to Expectation Shock", xtick = false)
plot!(xticks = period, xtickfontsize = 5)
xlabel!("4 Period Shock and After (5 to 50)")
ylabel!("Inflation (%)")
savefig("inflation_expectationshock4period.pdf")

inf = scatter(xaxis, inflation_model3, label="Inflation", xtick = false)
plot!(xticks = period, xtickfontsize = 5)
...
o = scatter(xaxis, output, label="Output's Response to Expectation Shock", xtick = false)
plot!(xticks = period, xtickfontsize = 5)
xlabel!("1st Period Shock and After (2 to 50)")
ylabel!("Output (50 is Long Run Equilibrium)")
savefig("output_expectationshock.pdf")

o = scatter(xaxis, output_model2, label="Output's Response to Expectation Shock", xtick = false)
plot!(xticks = period, xtickfontsize = 5)
xlabel!("4 Period Shock and After (5 to 50)")
ylabel!("Output (50 is Long Run Equilibrium)")
savefig("output_expectationshock4period.pdf")

o = scatter(xaxis, output_model3, label="Output", xtick = false)
plot!(xticks = period, xtickfontsize = 5)
xlabel!("Permanent Shock (1 to 50)")
ylabel!("Output (50 is Long Run Equilibrium)")
...
interest_rates = scatter(xaxis, nominal_interest, label="Nominal Interest Rate", xtick = false)
...
interest_rates = scatter(xaxis, nominal_interest_model2, label="Nominal Interest Rate Response to Expectation Shock", xtick = false)
...
interest_rates = scatter(xaxis, nominal_interest_model3, label="NIR", xtick = false)
